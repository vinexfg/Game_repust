...
def frame2():
    ...
    classe1 = tk.Button(grupo_classes, text="GUERREIRO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    classe1.pack( pady=2, padx=5, side="left")

    classe2 = tk.Button(grupo_classes, text="MAGO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    classe2.pack(pady=2, padx=5, side="left")

    classe3 = tk.Button(grupo_classes, text="LADINO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    classe3.pack(pady=2, padx=5, side="left")

    classe4 = tk.Button(grupo_classes, text="BÁRBARO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    ...
    raca1 = tk.Button(grupo_raca, text="HUMANO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    raca1.pack( pady=2, padx=5, side="left")

    raca2 = tk.Button(grupo_raca, text="ELFO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    raca2.pack(pady=2, padx=5, side="left")

    raca3 = tk.Button(grupo_raca, text="ANÃO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    raca3.pack(pady=2, padx=5, side="left")

    raca4 = tk.Button(grupo_raca, text="ORCS", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    ...
    sexo1 = tk.Button(frame_novo, text="MASCULINO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
    sexo1.pack(pady=2, padx=5)

    sexo2 = tk.Button(frame_novo, text="FEMININO", width=20, height=0, fg="#4EA68D", bg="#F2F2F2", font=("Agency FB", 15, "bold"), bd=5, relief="ridge")
